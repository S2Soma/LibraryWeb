...
import styles from './QLSach.module.scss';
...
const QLSach = () => {
  ...
  const handleAddBookClick = () => {
    navigate("/Sach/ThemSach");
  }
  const handleDetailShow = (book) => {
    navigate("/Sach/InfoBook", { state: { book } });
  }
    ...
    <Fragment>
      <div className={cx("QLSach-Container")}>
        <div className={cx("header")}>
          ...
          <div className={cx("add-book-button")}>
            <button className={cx("add-book-button")} onClick={handleAddBookClick}>
              Thêm sách
            </button>
          </div>
        </div>
